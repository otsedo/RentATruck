...
namespace RentATruck.Reportes.Accidentes
{
    public partial class Form1 : Form
    {
        datos objDatos = new datos();
        private static Form1 reporteAccidnetes = null;
        public Form1()
        {
            InitializeComponent();
        }

        public static Form1 InstanciaReporteAccidentes()
        {
            if ((reporteAccidnetes == null) || (reporteAccidnetes.IsDisposed == true))
            {
                reporteAccidnetes = new Form1();
            }
            reporteAccidnetes.BringToFront();
            return reporteAccidnetes;
        }
        ...
        private void cmdNuevo_Click_1(object sender, EventArgs e)
        {
            if (txtCamion.Text != "")
            {
                datos objDatos = new datos();
                objDatos.Conectar();
                objDatos.Consulta_llenar_datos("consulta_accidentes " + this.txtCamion.Text + "");

                Reportes.Accidentes.CrystalReport1 rp = new Reportes.Accidentes.CrystalReport1();
