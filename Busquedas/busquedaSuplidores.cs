...
{
    public partial class busquedaSuplidores : Form
    {
        ...
        private void cmdSeleccionar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Debe seleccionar un suplidor del listado", "Informacion", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                this.ReturnValue1 = row.Cells["codigo_suplidor"].Value.ToString();
