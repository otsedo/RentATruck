...
{
    public partial class busquedaCamionesAlquilados : Form
    {
        ...
        public busquedaCamionesAlquilados()
        {
            InitializeComponent();
        }

        private void busquedaCamionesAlquilados_Load(object sender, EventArgs e)
        {
            objDatos.Conectar();
            objDatos.Consulta_llenar_datos("select v.codveh_veh, m.descripcion, mv.descripcion, v.anoveh_veh, c.descripcion, v.descri_veh, v.numpla_veh, v.numcha_veh,v.kilome_veh from vehiculo v, marca_articulos m, tipo_vehiculos tv, modelos_vehiculos mv, colores c where v.codigo_marca = m.codigo_marca and v.codigo_tipo_vehiculo = tv.codigo_tipo_vehiculo and v.codigo_modelos =mv.codigo_modelos and c.codigo_color = v.codigo_color and v.alquilado = 1");
